...
import com.ayoncoder.tasknote.presentation.common.TaskNoteBottomNavItem
import com.ayoncoder.tasknote.navigation.Route
...
fun TaskNoteBottomNav(navController: NavController, currentTab: String = Route.Home::class.simpleName ?: "Home") {
    NavigationBar(containerColor = MaterialTheme.colorScheme.surface) {
        TaskNoteBottomNavItem.Home.route::class.simpleName?.let { route ->
            NavigationBarItem(
